 ...
 */
public class J48AttributeEval extends ASEvaluation implements
  ...
  protected J48SubsetEval m_wrapperTemplate = new J48SubsetEval();
      ...
      if (i != data.classIndex()) {
        ...
        Future<double[]> futureEval = m_pool.submit(new Callable<double[]>() {
          ...
          public double[] call() throws Exception {
            ...
            eval[0] = attIndex;
            J48SubsetEval evaluator = new J48SubsetEval();
  ...
  protected void resetOptions() {
    ...
    m_wrapperTemplate = new J48SubsetEval();
    m_wrapperSetup = "";
  }
  ...
  public static void main(String[] args) {
    runEvaluator(new J48AttributeEval(), args);
  }
}
