 ...
 *
 */
public abstract class ExternalDetectionAlgorithm extends DetectionAlgorithm {
	...
	public ExternalDetectionAlgorithm(DataSeries dataSeries, BasicConfiguration conf, boolean needNormalization) {
