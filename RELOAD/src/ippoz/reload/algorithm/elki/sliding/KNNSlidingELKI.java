...
public class KNNSlidingELKI extends DataSeriesSlidingELKIAlgorithm {
	 ...
	 */
	public KNNSlidingELKI(DataSeries dataSeries, BasicConfiguration conf) {
	...
	protected ObjectPair<Double, Object> evaluateSlidingELKISnapshot(SlidingKnowledge sKnowledge, Database windowDb, Vector newInstance, Snapshot dsSnapshot) {
		return new ObjectPair<Double, Object>(((CustomKNN) getAlgorithm()).calculateKNN(newInstance, windowDb), null);
	}
