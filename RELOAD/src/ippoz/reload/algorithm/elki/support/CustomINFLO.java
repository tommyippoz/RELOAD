...
public class CustomINFLO<O> extends AbstractDistanceBasedAlgorithm<O, OutlierResult> implements OutlierAlgorithm {
  /**
   * The logger for this class.
   */
  private static final Logging LOG = Logging.getLogger(CustomINFLO.class);
   ...
   * @param k k Parameter
   */
  public CustomINFLO(DistanceFunction<? super O> distanceFunction, double m, int k) {
  ...
  public static class Parameterizer<O> extends AbstractDistanceBasedAlgorithm.Parameterizer<O> {
    ...
    @Override
    protected CustomINFLO<O> makeInstance() {
      return new CustomINFLO<>(distanceFunction, m, k);
    }
  }
}
