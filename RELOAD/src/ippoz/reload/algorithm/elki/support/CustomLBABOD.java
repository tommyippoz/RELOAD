...
public class CustomLBABOD extends FastABOD<NumberVector> {
  /**
   * The logger for this class.
   */
  private static final Logging LOG = Logging.getLogger(CustomLBABOD.class);
   ...
   */
  public CustomLBABOD(SimilarityFunction<? super NumberVector> kernelFunction, int k, int l) {
  ...
  public OutlierResult run(Database db, Relation<NumberVector> relation) {
    ...
    SimilarityQuery<NumberVector> sq = db.getSimilarityQuery(relation, kernelFunction);
   ...
   * @apiviz.exclude
   */
  public static class Parameterizer extends FastABOD.Parameterizer<NumberVector> {
    /**
    ...
    @Override
    protected CustomLBABOD makeInstance() {
      return new CustomLBABOD(kernelFunction, k, l);
    }
  }
}