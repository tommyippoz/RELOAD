...
public abstract class Reputation {
	...
	public double evaluateReputation(DetectionAlgorithm alg, Knowledge knowledge){
		...
		for(int i=0;i<knowledge.size();i++){
			...
			anomalyEvaluations.add(new AlgorithmResult(knowledge.getInjection(i) != null, algScore, aRes.getScoreEvaluation(), aRes.getDecisionFunction(), alg.getConfidence(algScore)));
		}
